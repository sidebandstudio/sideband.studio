        ...
        return (
          <FadeUp key={img.src} delay={(i % 4) * 0.05} className={span}>
            <div className="group relative h-full w-full overflow-hidden border border-sideband-border bg-sideband-surface-2">
              ...
              />
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-sideband-black/80 via-transparent to-transparent opacity-90 transition-opacity duration-300 group-hover:opacity-70" />
              {img.caption && (
                <span
                  aria-hidden
