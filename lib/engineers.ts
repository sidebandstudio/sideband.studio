...
export const engineers: Engineer[] = [
  {
    ...
    longBio: [
      'Ali architects scalable enterprise infrastructure and ships products end-to-end. CS & Political Science at Northeastern University, currently SWE Co-op at Philips in Cambridge, MA — and joining AWS Amazon Dedicated Cloud (ADC) in Seattle as an SDE Intern for Summer 2026.',
    ...
    portrait: {
      src: '/assets/engineers/ali-younes/portrait.png',
      width: 1200,
      height: 1500,
    },
    accentColor: '#A855F7',
    prev: [
      { label: 'AMAZON', sublabel: 'AWS ADC · SDE INTERN · SUMMER 26' },
    ...
    lifestyle: [
      {
        ...
        alt: 'Ali Younes — off the clock',
      },
      {
        src: '/assets/engineers/ali-younes/lifestyle/bmw-tuning.jpg',
        alt: 'Supercharged S4 — full engine tune',
      ...
      {
        src: '/assets/engineers/ali-younes/lifestyle/sumo-bot.png',
      ...
      {
        src: '/assets/engineers/ali-younes/lifestyle/roblox-dev.png',
  ...
  },
  {
    ...
    longBio: [
      ...
      'Incoming Web Application Developer (AI Integration) at MIT Lincoln Laboratory for Jul–Dec 2026. Past frontend co-op at Top Choice Realty in Staten Island. His work spans Next.js / Node web surfaces and Python / Lua / FFmpeg media pipelines.',
    ],
    portrait: {
    ...
    accentColor: '#6366F1',
    prev: [
      { label: 'MIT LINCOLN LAB', sublabel: 'INCOMING · JUL 26' },
    ...
    experience: [
      {
        ...
        emphasis: true,
        summary:
          'Incoming role building AI-integrated internal web applications inside MIT’s federally funded R&D center.',
    ...
    projects: [
      ...
      },
      {
        ...
        blurb:
          'Chrome MV3 extension for instant webpage summarization. Server-side proxying via Node / Express, OpenAI API on the backend.',
        href: '/products/eternal-summary',
        internal: true,
        tech: ['Chrome MV3', 'Node', 'Express', 'OpenAI API'],
      },
      {
...
export function getOtherEngineer(currentId: string): Engineer | undefined {
  return engineers.find((e) => e.id !== currentId)
}
