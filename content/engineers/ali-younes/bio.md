...
**Languages:** TypeScript / JavaScript (expert), C++ (advanced), C# / .NET (proficient), Python (proficient), Rust (proficient), Swift / SwiftUI (intermediate), Go (learning)

**Frontend:** React 19 · TypeScript · Tailwind CSS · Framer Motion · Next.js 14

**Backend & Systems:** Node.js · Express 5 · MongoDB · SQLite · Linux · PowerShell

**Cloud & Infrastructure:** AWS · IaC (CDK / CloudFormation) · UEFI Secure Boot · PXE / TFTP · DevOps

**Platforms:** DXGI (H.264 encoding) · VideoToolbox (Metal) · HealthKit · Gemini 2.0 Flash · Microservices
